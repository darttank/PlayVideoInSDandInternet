...
public class PlayLocationVideoInSDActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.acticity_play_sd_video);
	...
	protected void play(int msec) {
		...
		//String path2 = ""+Environment.getExternalStorageDirectory()+"/TZH.mp4";//等价上面的地址
